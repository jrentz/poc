...
# echo "pushing needed scripts to minions and running..."
# sed -i "s/WEB_IP/$WEB_IP/" ./FixDBaccess.sh
# salt-cp $DB_ID ./FixDBaccess.sh /root/
# salt $DB_ID cmd.run "chmod 755 /root/FixDBaccess.sh;/root/FixDBaccess.sh"
dbaccess $DB_ID $WEB_IP

# update index.php and send down to webserer
phpconfig $WEB_ID $WEB_IP

 salt-cp $WEB_ID ./index.php /var/www/html/index.php 
